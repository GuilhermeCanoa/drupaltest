...
/**
 * Provides a form for reverting a Produtos revision.
 *
 * @ingroup modulo_teste
 */
class ProdutosRevisionRevertForm extends ConfirmFormBase {
  ...
  public function getFormId() {
    return 'produtos_revision_revert_confirm';
  }
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $this->logger('content')->notice('Produtos: reverted %title revision %revision.', ['%title' => $this->revision->label(), '%revision' => $this->revision->getRevisionId()]);
    $this->messenger()->addMessage(t('Produtos %title has been reverted to the revision from %revision-date.', ['%title' => $this->revision->label(), '%revision-date' => $this->dateFormatter->format($original_revision_timestamp)]));
   ...
   *
   * @param \Drupal\modulo_teste\Entity\ProdutosInterface $revision
